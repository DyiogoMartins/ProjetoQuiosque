 ...
 * @author diogo e eric
 */
public class Tela_Menu_Cad extends javax.swing.JInternalFrame {
    ...
    private void cadastrar_menu() {
        String sql = "insert into tb_menu (nomeMenu, Tipo, Preco, obs) "
                + "values(?, ?, ?, ?)";
        ...
        try {
            ...
            if ((AtxtObs.getText().trim().isEmpty())
                    || (AtxtNome.getText().toString().trim().isEmpty())
...
//                System.out.println(adicionado);
                ...
                if (adicionado > 0) {
                    ...
                    if (rs.next()) {
                        idMenu = rs.getInt(1); //idCli gerado
                        getCadastrarLogMenu(3); // insert
                        limpar();
                    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Tela Cadastro de Menu");
        setToolTipText("");
    ...
    private javax.swing.JPanel pnCima1;
