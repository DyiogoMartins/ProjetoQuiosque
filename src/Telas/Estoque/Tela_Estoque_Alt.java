 ...
 * @author DIOGO e eric
 */
public class Tela_Estoque_Alt extends javax.swing.JInternalFrame {
...
//            JOptionPane.showMessageDialog(null, e);
    ...
    private void setarCamposProd() {
        ...
        cboCategoria.setSelectedItem(tblProd.getModel().getValueAt(setar, 2).toString());
        AtxtObs.setText(tblProd.getModel().getValueAt(setar, 4).toString());
        qtnProd = (int) tblProd.getModel().getValueAt(setar, 3);
    }

    private void alterar() {

        String sql = "UPDATE tb_estoque"
                + " SET tb_estoque.produto= ?,"
                + " tb_estoque.categoria= ?,"
                + " tb_estoque.obs= ?"
                + " WHERE tb_estoque.idEstoq = ?";

        try {
            pst = conexao.prepareStatement(sql);
            //pst = conexao.prepareStatement(sql_1);

            pst.setString(1, AtxtProd.getText());
            pst.setString(2, cboCategoria.getSelectedItem().toString());
            pst.setString(3, AtxtObs.getText());
            pst.setString(4, txt_IdProd.getText());
            ...
            // chama a funcao que trata personalizadamente as Exceptions
    ...
    private void remover() {
        int confirmar = JOptionPane.showConfirmDialog(null, "Tem certeza que "
                + "deseja desativar os valores deste produto?",
        ...
        if (confirmar == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                if (apagado > 0) {
                    ...
                    getCadastrarLogEst(2); // DELETE
                    consultarProduto();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Ocorreu algum erro ao deletar",
                            "Atenção!",
                            HEIGHT);
                }
                ...
                if (e.toString().contains("a foreign key constraint fails")) {
                    JOptionPane.showMessageDialog(null,
                            "Produto vinculado com ações do sistema! \n\n",
    ...
    private void getCadastrarLogEst(int i) {
        // cadastra log 

        int idEst = Integer.parseInt(txt_IdProd.getText());
    ...
    private void initComponents() {
        ...
        btnrExc = new javax.swing.JButton();
        ...
        btnLimp.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        btnLimp.setText("Limpar");
        btnLimp.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        btnLimp.setMaximumSize(new java.awt.Dimension(45, 45));
        btnLimp.setMinimumSize(new java.awt.Dimension(45, 45));
        btnLimp.setPreferredSize(new java.awt.Dimension(45, 45));
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        pnCima.add(btnLimp, gridBagConstraints);
        ...
        cboCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Carnes", "Produtos lácteos", "Vegetais", "Produtos de padaria", "Produtos congelados", "Grãos e cereais", "Bebidas", "Produtos enlatados e embalados", "Produtos de panificação", "Ingredientes especiais", "Temperos", "Não informado" }));
        ...
        btnrExc.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        btnrExc.setText("Excluir");
        btnrExc.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        btnrExc.setMaximumSize(new java.awt.Dimension(2147483647, 2147483647));
        btnrExc.setMinimumSize(new java.awt.Dimension(45, 45));
        btnrExc.setPreferredSize(new java.awt.Dimension(45, 45));
        btnrExc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnrExcActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        pnBaixo.add(btnrExc, gridBagConstraints);
    ...
    private void btnrExcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnrExcActionPerformed
        remover();
    }//GEN-LAST:event_btnrExcActionPerformed
    ...
    private javax.swing.JButton btnrExc;
